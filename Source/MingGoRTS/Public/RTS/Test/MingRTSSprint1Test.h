...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Test")
    FSprint1TestResult TestMoveConmand(};

    UFUNCTION(BlueprintCallable, Category = "Test")
    FSprint1TestResult TestGroupManagement(};

    UFUNCTION(BlueprintCallable, Category = "Test")
    FSprint1TestResult TestConbatDamage(};
    ...
    UFUNCTION(BlueprintCallable, Category = "Test")
    FSprint1TestResult TestAIConbatReactions(};
...
public:
    ...
    UPROPERTY(BlueprintAssignable, Category = "TestEvents")
