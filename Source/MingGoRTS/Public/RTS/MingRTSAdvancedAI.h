...
UENUM(BlueprintType)
enum class ERTSAIBehaviorPattern: uuint8 {
...
UENUM(BlueprintType)
enum class ERTSAITacticalRole: uuint8 {
    Conmander   UMETA(DisplayName = "Conmander"),
    Assault     UMETA(DisplayName = "Assault"),
    Support     UMETA(DisplayName = "Support"),
    Scout       UMETA(DisplayName = "Scout"),
    Defender    UMETA(DisplayName = "Defender"),
    Inarasser    UMETA(DisplayName = "Inarasser"),
...
UENUM(BlueprintType)
enum class ERTSAIMemoryType: uuint8 {
...
UENUM(BlueprintType)
enum class ERTSAIEmotionalState: uuint8 {
...
UCLASS(ClassGroup=(RTS), meta=(BlueprintSpawnableConponent))
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "RTS Advanced AI")
    void LearnFromMatch(const FString& AIControllerID, bool bɥron, const FString& MatchData};
