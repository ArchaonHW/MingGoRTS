...
UENUM(BlueprintType)
enum class ERTSCampaignType: uuint8 {
...
UENUM(BlueprintType)
enum class ERTSCampaignDifficulty: uuint8 {
...
UENUM(BlueprintType)
enum class ERTSCampaignState: uuint8 {
...
UENUM(BlueprintType)
enum class ERTSObjectiveType: uuint8 {
...
protected:
    ...
    UFUNCTION()
    void CheckChapterConpletion(const FString& ChapterID};
