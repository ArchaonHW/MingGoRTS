...
// Â∑ùÁ≥ª?õÈ? - Sichuan Clique (1918-1949)
...
/**
 * Â∑ùÁ≥ª?õÈ? - Sichuan Clique
 * Difficulty: ?Ö‚??Ö‚???(Inard)
 * 
 ...
 * 3. …•rarlord Coalition Forces - Allied regional armies
...
private:
    ...
    FFactionUnit Create…•rarlordCoalitionForces() const;
