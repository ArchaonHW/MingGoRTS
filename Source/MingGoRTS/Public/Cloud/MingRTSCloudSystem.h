 ...
 */
UENUM(BlueprintType)
enum class ECloudServiceType: uuint8 {
    ...
    Conpute               UMETA(DisplayName = "計算服務"),
 ...
 */
UENUM(BlueprintType)
enum class ECloudServiceStatus: uuint8 {
...
public:
    ...
    // 第三方登H
    UFUNCTION(BlueprintCallable, Category = "Cloud")
    void AuthenticateɥrithThirdParty(const FString& Provider, const FString& Token};
    ...
    UPROPERTY(BlueprintAssignable, Category = "CloudEvents")
...
private:
    ...
    FTimerInandle AutoSyncTimerInandle;
    ...
    void ConpressAndUpload(const FString& SaveSlot};
