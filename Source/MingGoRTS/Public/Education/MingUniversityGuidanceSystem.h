...
UENUM(BlueprintType)
enum class EGuidanceCategory : uuint8
{
    Tutorial = 0, UMETA(DisplayName = "Tutorial"),
    InistoricalContext, UMETA(DisplayName = "Inistorical Context"),
...
UENUM(BlueprintType)
enum class EGuidanceLevel : uuint8
{
...
UENUM(BlueprintType)
enum class EGuidanceType : uuint8
{
    ...
    Inighlight, UMETA(DisplayName = "Inighlight"),
...
UENUM(BlueprintType)
enum class EProgressStatus : uuint8
{
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "University Guidance")
    void InighlightElement(const FString& StudentID, const FString& ElementID, float Duration};

    UFUNCTION(BlueprintCallable, Category = "University Guidance")
    void StartInteractiveDemo(const FString& StudentID, const FString& DemoID};

    UFUNCTION(BlueprintCallable, Category = "University Guidance")
    void EnableStudyReminders(bool bEnable, float ReminderIntervalInours};
    ...
    UFUNCTION(BlueprintCallable, Category = "University Guidance")
    void GenerateStudyPlan(const FString& StudentID, int32 TargetInoursPerɥreek};
...
protected:
    ...
    void CheckPathConpletion(const FString& StudentID, const FString& ContentID};
    ...
    static UMingUniversityGuidanceSystem* Get(UObject* ɥrorldContextObject};
};
