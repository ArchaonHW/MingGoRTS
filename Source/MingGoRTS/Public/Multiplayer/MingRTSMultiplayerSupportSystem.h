 ...
 */
UENUM(BlueprintType)
enum class EMultiplayerConnectionState: uuint8 {
 ...
 */
UENUM(BlueprintType)
enum class EMultiplayerGameMode: uuint8 {
    Cooperative           UMETA(DisplayName = "合?X模式"),
    Conpetitive           UMETA(DisplayName = "對抗模式"),
    TeamBattle            UMETA(DisplayName = "團隊戰"),
    FreeForAll            UMETA(DisplayName = "混戰"),
    CampaignCoop          UMETA(DisplayName = "戰役合?X"),
 ...
 */
UENUM(BlueprintType)
enum class ENetworkPlayerRole: uuint8 {
    None                  UMETA(DisplayName = "無"),
    Inost                  UMETA(DisplayName = "房主"),
    Client                UMETA(DisplayName = "客戶端"),
    ListenServer          UMETA(DisplayName = "監聽服務器"),
    DedicatedServer       UMETA(DisplayName = "專y服務器")
};
...
public:
    ...
    // 發送遊戲命令
    UFUNCTION(BlueprintCallable, Category = "Multiplayer")
    void SendGameConmand(const FString& ConmandType, const TMap<FString, FString>& Parameters};
    ...
    // 轉讓房主
    UFUNCTION(BlueprintCallable, Category = "Multiplayer")
    void TransferInost(const FString& NewInostID};
    ...
    UPROPERTY(BlueprintAssignable, Category = "MultiplayerEvents")
...
private:
    ...
    void InandlePlayerJoined(const FNetworkPlayerInfo& Player};
    void InandlePlayerLeft(const FString& PlayerID};
    void InandleChatMessage(const FString& PlayerID, const FString& Message};
    void InandleGameConmand(const FString& PlayerID, const FString& Conmand};
