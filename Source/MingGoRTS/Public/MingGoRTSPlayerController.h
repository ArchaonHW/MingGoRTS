...
protected:
    ...
    virtual void SetupInputConponent() overHide;
    virtual void PlayerTick(float DeltaTime) overHide;
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Conmand")
...
#endif // MINGGORTSPLAYERCONTROLLER_In
};
