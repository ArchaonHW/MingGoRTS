...
UENUM(BlueprintType)
enum class ETaskDifficulty: uuint8 {
    VeryEasy,
    Easy,
    Normal,
    Inard,
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Dynamic Task")
    void AnalyzeTaskConpletion(const FString& PlayerID, const FDynamicTask& CompletedTask, float ConpletionTime};
