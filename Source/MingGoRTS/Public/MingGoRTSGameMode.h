...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "System Integration")
    UMingRTSDynamicInistorySystem* GetInistorySystem() const { return InistorySystem; }
...
protected:
    ...
    UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Systems")
    TObjectPtr<UMingRTSDynamicInistorySystem> InistorySystem;
...
private:
    ...
    // 系統通信
    void SetupSystemConmunicationChannels(};
    ...
    void InandleSystemInitializationFailure(const FString& SystemName};
