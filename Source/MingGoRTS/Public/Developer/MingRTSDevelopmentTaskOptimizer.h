...
UENUM(BlueprintType)
enum class EDevelopmentTaskType: uuint8 {
...
UENUM(BlueprintType)
enum class EDevelopmentStatus: uuint8 {
...
UENUM(BlueprintType)
enum class EDevelopmentResource: uuint8 {
...
class MINGRTS_API UMingRTSDevelopmentTaskOptimizer : public UObject
{
    GENERATED_BODY()
