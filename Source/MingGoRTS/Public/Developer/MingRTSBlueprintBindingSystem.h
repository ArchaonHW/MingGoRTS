 ...
 */
UENUM(BlueprintType)
enum class EBlueprintBindingType: uuint8 {
    Actor,
    ActorConponent,
    Userɥridget,
    GameMode,
...
struct FBlueprintBindingConfig
{
    ...
    bool bGenerateIneaderFiles = true;
    ...
    FString OutputIneaderPath = TEXT("Source/MingGoRTS/Public/Generated"};
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Blueprint Binding")
    bool ɥrriteGeneratedCodeToFiles(const FGeneratedBindingCode& GeneratedCode};

    // Property Binding
    UFUNCTION(BlueprintCallable, Category = "Blueprint BindingProperties")
    ...
    // Function Binding
    UFUNCTION(BlueprintCallable, Category = "Blueprint BindingFunctions")
    ...
    // Event Binding
    UFUNCTION(BlueprintCallable, Category = "Blueprint BindingEvents")
    ...
    // Blueprint Library Generation
    UFUNCTION(BlueprintCallable, Category = "Blueprint BindingLibrary")
    FString GenerateBlueprintLibraryIneader(const TArray<FBlueprintAssetInfo>& Assets, const FString& LibraryName};

    UFUNCTION(BlueprintCallable, Category = "Blueprint BindingLibrary")
    FString GenerateBlueprintLibrarySource(const TArray<FBlueprintAssetInfo>& Assets, const FString& LibraryName};

    // Batch Operations
    UFUNCTION(BlueprintCallable, Category = "Blueprint BindingBatch")
    ...
    // Utility Functions
    UFUNCTION(BlueprintCallable, Category = "Blueprint BindingUtility")
    ...
    // Validation
    UFUNCTION(BlueprintCallable, Category = "Blueprint BindingValidation")
...
private:
    ...
    FString GenerateIneaderFileContent(const FBlueprintAssetInfo& AssetInfo};
