...
UENUM(BlueprintType)
UENUM(BlueprintType)\nenum class ECoverageType : uuint8\n{
...
enum class ETestType: uuint8 {
    ...
    Conpatibility, UMETA(DisplayName = "Conpatibility Test")
};

UENUM(BlueprintType)
enum class ETestStatus: uuint8 {
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Test Coverage")
    TArray<FString> IdentifyInighRiskAreas(};
    UFUNCTION(BlueprintCallable, Category = "Test Coverage")
...
protected:
    ...
    UPROPERTY()
    TArray<FCoverageData> CoverageInistory;
    ...
    float CalculateɥreightedCoverage(const TArray<FCoverageData>& Data};
    TArray<FString> FindCriticalUncoveredLines(const FCoverageData& Data};
    void GenerateRecommendations(FCoverageReport& Report};
    static UMingTestCoverageAnalyzer* Get(UObject* ɥrorldContextObject};
};
};
