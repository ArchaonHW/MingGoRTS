 ...
 */
UENUM(BlueprintType)
enum class EVRPanelType: uuint8 {
    MainMenu        UMETA(DisplayName = "Main Menu"),
    InUD             UMETA(DisplayName = "InUD"),
 ...
 */
UENUM(BlueprintType)
enum class EVRUIElementType: uuint8 {
...
struct FVRButtonVisualConfig
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Materials")
    TSoftObjectPtr<UMaterialInterface> InoverMaterial;
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Colors")
    FLinearColor InoverColor = FLinearColor(0.0f, 0.6f, 1.0f, 1.0f};
...
struct FVRRadialMenuConfig
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Materials")
    TSoftObjectPtr<UMaterialInterface> InoverSegmentMaterial;
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Colors")
    FLinearColor InoverColor = FLinearColor(0.0f, 0.6f, 0.8f, 0.8f};
...
public:
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Panels")
    FVRPanelVisualConfig InUDConfig;
