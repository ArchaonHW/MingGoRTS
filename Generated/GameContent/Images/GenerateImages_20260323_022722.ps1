...
foreach ($image in $images) {
    Invoke-ImageGeneration -ImageName $image -Type "Character" -Description "Auto-generated image" -ArtStyle "Cartoon" -Resolution "2048x2048" -Format "PNG"
}
