...
enum class EReleaseTestCategory : uint8
{
    ...
    Epic3_AICampaign,       // Epic 3.1: AI X�ԧШtX    Epic4_UIAudio,          // Epic 4.1: UI X��X�tX    Epic5_Network,          // Epic 5.1: ���X�HX�tX    Epic6_SaveLoad,         // Epic 6.1: �OX�tX    Epic7_Localization,     // Epic 7.1: X�aX�tX    Epic8_Performance,      // Epic 8.1: X��X�ոըtX    Epic9_AIContentGen,     // Epic 9: AI X�eX�t��
    Epic10_FourLayer,       // Epic 5: X�h����X�t��
    SystemIntegration,      // X�t�ξ�X    FinalValidation,  // X��X};
