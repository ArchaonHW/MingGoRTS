...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnRelationshipClicked, FName, CharacterID};
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnViewModeChanged, EMingRelationshipViewMode, NewMode};
