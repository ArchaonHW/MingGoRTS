...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnDialogueOptionSelected, int32, OptionID, EMingDialogueOptionType, OptionType};
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnRelationshipImpacted, FName, RegionID, float, DeltaValue};
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnReputationImpacted, FName, RegionID, float, DeltaValue};
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnDialogueStarted};
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnDialogueEnded};
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnOptionHovered, int32, OptionID};
