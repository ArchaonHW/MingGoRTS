...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnReputationClicked, FName, RegionID};
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnViewModeChanged, EMingReputationViewMode, NewMode};
