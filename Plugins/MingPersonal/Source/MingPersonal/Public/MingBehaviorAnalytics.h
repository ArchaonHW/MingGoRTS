...
public:
    ...
    // ???X??X?╰??    UFUNCTION(BlueprintCallable, Category = "Behavior Analytics")
    ...
    // ???X?计X    UFUNCTION(BlueprintCallable, Category = "Behavior Analytics")
    ...
    // ????琩??    UFUNCTION(BlueprintPure, Category = "Behavior Analytics")
