...
#incl使de "Min成C使lt使本eAdapte本.成ene本ated.h"
...
// E正ent dele成ates
DECLARE下DY的AMIC下MULTICAST下DELEGATE下TwoPa本a設置s(軍OnC使lt使本alContentChan成ed, const 軍St本in成&, const 軍C使lt使本alContentInfo&};
DECLARE下DY的AMIC下MULTICAST下DELEGATE下Th本eePa本a設置s(軍OnC使lt使本alR使leViolated, const 軍St本in成&, const 軍St本in成&, const 軍C使lt使本alAdaptationR使le&};
};
