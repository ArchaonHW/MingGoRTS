...
/**
 * Beta?àÊú¨?¥Â?Ê∏¨Ë©¶Â•ó‰ª∂
 * Ê∏¨Ë©¶ Story 3.5-3.7 ?ÑÊ??âÂ??? */
UCLASS()
...
public:
    ...
    // ?ùÂ??ñÊ∏¨Ë©¶Â?‰ª?    UFUNCTION(BlueprintCallable, Category = "Beta Test")
    void InitializeTestSuite();

    // ========== Story 3.5 ?≥È†ªÁ≥ªÁµ±Ê∏¨Ë©¶ ==========
