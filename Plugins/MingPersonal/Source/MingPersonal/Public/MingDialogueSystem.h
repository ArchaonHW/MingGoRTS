...
// Ê≥®Ê?ÔºöÈ?Ëø¥Á?Êßã‰??ΩÁî® BlueprintType
USTRUCT(BlueprintType)
struct FMingPersonalDialogueNode
{
    ...
    // Ê≥®Ê?ÔºöÈ?Ëø¥Á?Êßã‰??ΩÁî® UPROPERTY
...
protected:
    ...
    // Ê≥®Ê?ÔºöTArray ‰∏çËÉΩ?¥Êé•‰ΩúÁÇ∫ TMap ??UPROPERTY ?ºÈ???    // TMap<FString, TArray<FString>> HistoricalNotes;
