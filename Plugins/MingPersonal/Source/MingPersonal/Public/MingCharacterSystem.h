...
protected:
    ...
    // Ê≥®Ê?ÔºöTMap ‰∏çËÉΩ?¥Êé•‰ΩúÁÇ∫ TMap ??UPROPERTY ?ºÈ???    // TMap<FString, TMap<FString, float>> CharacterRelationships;

    // Ê≥®Ê?ÔºöTArray ‰∏çËÉΩ?¥Êé•‰ΩúÁÇ∫ TMap ??UPROPERTY ?ºÈ???    // TMap<FString, TArray<FString>> CharacterEffects;

    // Ê≥®Ê?ÔºöTArray ‰∏çËÉΩ?¥Êé•‰ΩúÁÇ∫ TMap ??UPROPERTY ?ºÈ???    // TMap<FString, TArray<FString>> HistoricalEvents;
