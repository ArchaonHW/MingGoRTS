...
struct FMingTriggerCondition
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite)
    EMingResourceType ResourceType; // For ResourceThreshold
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "Presets")
    FString CreateResourceGoalTrigger(const FString& TriggerName, EMingResourceType Resource, int32 TargetAmount);

    UFUNCTION(BlueprintCallable, Category = "Presets")
    FString CreateUnitCountTrigger(const FString& TriggerName, int32 MinUnitCount);

    UFUNCTION(BlueprintCallable, Category = "Presets")
    FString CreateBuildingTrigger(const FString& TriggerName, EMingBuildingType BuildingType);
