...
#incl使de "基本indowsPlatfo本設置Adapte本.成ene本ated.h"

/**
 * 基本indows 平台動務 */
UCLASS()
class MI的GCORE下API U基本indowsPlatfo本設置Adapte本 : p使blic UOb大ect, p使blic IPlatfo本設置Inte本face
{
    GE的ERATED下BODY()

p使blic:
    U基本indowsPlatfo本設置Adapte本(};

    // IPlatfo本設置Inte本face 實現
    ...
    // 基本indows 動池能
    U軍U的CTIO的(Bl使ep本intCallable, Cate成o本y = "Platfo本設置基本indows")
    bool IsR使nnin成OnBatte本y() const;

    U軍U的CTIO的(Bl使ep本intCallable, Cate成o本y = "Platfo本設置基本indows")
    軍St本in成 Get基本indowsVe本sion() const;
