...
public:
    ...
    // X����X    UFUNCTION(BlueprintCallable, Category = "AI Content Renderer")
    ...
    // X�dX    UFUNCTION(BlueprintPure, Category = "AI Content Renderer")
