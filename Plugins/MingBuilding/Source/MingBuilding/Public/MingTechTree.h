...
// �`??�GTArray ??��XUPROPERTY ??�n?X?�w����w�q
USTRUCT(BlueprintType)
struct FMingBuildingUpgradeList
{
    GENERATED_BODY()

    // XUPROPERTY�A?XFMingBuildingUpgrade ??����摧毀
...
/**
 * ��?X??X???��?? | Building Upgrade Data Structure
 * �w�q��?X??X?��???X?�� | Define building upgrade properties and costs
 */
USTRUCT(BlueprintType)
struct FMingBuildingUpgrade
{
    ...
    /** 目標數量(?? | Upgrade Time (seconds) */
    UPROPERTY(EditAnywhere, BlueprintReadOnly)
    float UpgradeTime;

    /** ??�j??��摧毀| Max Upgrade Level */
    UPROPERTY(EditAnywhere, BlueprintReadOnly)
    ...
    /** �C?X?��目標數量 | Production Multiplier per level */
    UPROPERTY(EditAnywhere, BlueprintReadOnly)
    float ProductionMultiplier;

    /** �C?X?�m摧毀 | Defense Multiplier per level */
    UPROPERTY(EditAnywhere, BlueprintReadOnly)
...
public:
    ...
    /** �]�m�q??��?X??X?�m | Setup Default Building Upgrades */
    UFUNCTION(BlueprintCallable, Category = "Upgrades")
